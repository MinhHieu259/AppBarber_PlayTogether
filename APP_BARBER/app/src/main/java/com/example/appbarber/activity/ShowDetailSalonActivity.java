...
private int id_salon = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_yeuthich.setOnClickListener(v->{
            StringRequest request = new StringRequest(Request.Method.POST, Constaint.YEU_THICH, response -> {
                try {
                    JSONObject object = new JSONObject(response);
                    if (object.getBoolean("success")){
                        StringRequest request2 = new StringRequest(Request.Method.GET, Constaint.GET_SALON_BY_ID+"/"+id_salon, res->{
